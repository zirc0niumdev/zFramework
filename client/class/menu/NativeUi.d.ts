...
export default class NativeUI {
    ...
    constructor(title: string, subtitle: string, offset: Point, spriteLibrary?: string, spriteName?: string, inputCanClose?: boolean);
    ...
    SetCloseableByUser(toggle: boolean): void;
    ...
    AddItems(items: Array<UIMenuItem>): void;
